...
class AddIncome extends Component {
    ...
    onSetAmount = () => {
        this.props.history.push('/income/category');
    }

    onSelectCategory = (categoryId) => {
        this.props.updateTransactionField('categoryId', categoryId);
        this.props.history.push('/income/desc');
    }
...
export default withRouter(connect(mapStateToProp, mapDispatchToProp)(AddIncome));